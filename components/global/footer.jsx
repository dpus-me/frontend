    ...
    <footer>
      <div className="footer-container">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <div className="footer-sns">
              <a target="_blank" href="https://github.com/dpus-me/">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <a target="_blank" href="https://www.instagram.com/ekal_.index/">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="footer-sections">
            ...
            <section className="support">
              ...
              <div className="footer-item-container">
                ...
                <a>저작권 침해 신고</a>
                <Link target="_blank" href="https://github.com/dpus-me">
                  오픈 소스
                </Link>
              </div>
            </section>
            <section className="legal">
              ...
              <div className="footer-item-container">
                ...
                <Link href="/docs/license">라이선스</Link>
              </div>
            </section>
        ...
        <div className="footer-info">
          <p>
            ⓒ {new Date().getFullYear()} Damie Original Series. all rights
            reserved.
          </p>
        </div>
      </div>
