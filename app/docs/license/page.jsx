  ...
  return (
    <div>
      ...
      <p className="page-subtitle">
        DPUS는 오픈 소스 커뮤니티로서, 아래 라이선스를 따라요.
      </p>
      <div className="docs-info">
        ...
        <h2 id="license-grants-and-conditions">
        ...
        <h3 id="distribution-of-source-form">
        ...
        <h3 id="distribution-of-a-larger-work">
      ...
      <div className="license-korean">
        <p>
          한국어 전문은{" "}
          <Link
            href={
              "https://www.olis.or.kr/license/Detailselect.do?lId=1088&mapCode=010001,010107"
            }
            target="_blank"
          >
            여기
