...
export default function ServicePolicy() {
  return (
    <main>
      ...
      <p className="page-subtitle">DPUS를 이용할 때, 아래 원칙을 지켜주세요.</p>
      <div className="docs-info">
        <h1>DPUS 서비스 이용 약관</h1>
        <h2>제 1 장 총칙</h2>
        <h3>제 1 조 (목적)</h3>
        <p>
          본 약관은 다미 오리지널 시리즈(이하 "회사")가 운영하는 웹 사이트
          (https://dpus.me/)의 제반 서비스의 이용조건 및 절차에 관한 사항 및
        ...
        <p>
          ...
          따라 처리한다. 다만 이미 대금을 지불한 경우에는 제18조의 ‘반품규정’을
          따른다.
        </p>
        <h3>제17조 (배송정책)</h3>
        <p>
          ① ‘회사’는 이용자와 재화의 공급시기에 관하여 별도의 약정이 없는 이상,
          이용자가 결재를 실시한 날부터 7일 이내에 재화 등을 배송할 수 있도록
          주문제작, 포장 등 기타의 필요한 조치를 취한다.
        </p>
        <p>
        ...
        <p>
          ...
          이내에 환급하거나 환급에 필요한 조치를 한다.
        </p>
        <p>
          ① 재화가 발송 되기전 이용자가 결제를 취소할 경우 ‘회사’는 해당
          주문건을 취소 처리하고 카드결제 승인을 취소한다.
        </p>
        <p>
          ② 재화가 발송 된 이후 결제 취소는 불가하다. 단, ‘회사’의 부주의
          ‘배송’상의 문제로 인한 재화의 파손, 변질의 경우 ‘회사’는 이용자에게
          구매 금액의 반품 및 환불 조취 및 교환 조취를 취한다.
        </p>
        <h2>제 6 장 기타</h2>
        ...
        <h2>부칙</h2>
        <p>본 약관은 2024년 04월 21일부터 적용한다.</p>
      </div>
    </main>
  );
}
